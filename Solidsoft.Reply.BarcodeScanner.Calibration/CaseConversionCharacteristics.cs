...
internal class CaseConversionCharacteristics(
    ...
    /// </summary>
    private readonly IReadOnlyList<string> _segmentCharacters = segmentCharacters;
    ...
    public bool? CapsLockState { get; } = capsLockState;
    ...
    /// </summary>
    private string KeyboardScript { get; } = keyboardScript;
